...
import { SelendraEvmTX, checkSignatureType, parseTransaction } from '../eth-transactions';
...
export abstract class BaseProvider extends AbstractProvider {
  ...
  chainId = async (): Promise<number> => {
    return Number(this.api.consts.evmAccounts.chainId.toString());
  };
